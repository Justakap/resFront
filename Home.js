...
export default function Home() {
    ...
    useEffect(() => {
      // This effect will calculate the CGPA once the component mounts
      ...
      // Send CGPA to the backend
      axios
        .post('/api/save-cgpa', { cgpa: calculatedCgpa })
        .then((response) => {
          console.log('CGPA saved successfully:', response.data);
        })
        .catch((error) => {
