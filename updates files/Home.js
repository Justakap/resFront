  ...
  return (
    <div className="report-container">
      ...
      <div className="input-file w-4/5">
        <p className="mx-5 font-semibold">Upload your Result :</p>
        <input
          type="file"
        ...
        {url && (
          <button
            onClick={send}
            className="bg-blue-800 text-white font-bold p-2 rounded-lg"
          >
            Get Analysis
            {loading && (
              <div
                className="mx-3 inline-block h-4 w-4 animate-spin rounded-full border-4 border-solid border-current border-r-transparent align-[-0.125em] text-primary motion-reduce:animate-[spin_1.5s_linear_infinite]"
                role="status"
              >
      ...
      {data ? (
        <>
              ...
              <thead className="text-xs text-gray-700 uppercase bg-gray-50">
                ...
                <tr>
                  ...
                  <th scope="col" className="text-left px-6 py-2 border-2">
                    ...
                    <span
                      className={`${
                        data.Result === "PASS" ? "bg-green-100" : "bg-red-100"
            ...
            <div className="relative overflow-x-auto">
              {data.Result === "PASS" ? (
                <>
                  ...
                  <table className="text-center w-full m-auto border-l-2 border-r-2 border-b-2 text-sm rtl:text-right text-gray-500 ">
                    <thead className="text-xs  text-gray-700 uppercase bg-gray-50 ">
                      <tr>
                        ...
                        <th scope="col" className=" text-left    px-6 py-3">
                          {data.semester > 4 ? (
                            <>
                              CGPA :{" "}
                              {(totalCreditPoints / totalCredits).toFixed(2)} -{" "}
                              {((totalCreditPoints + 2) / totalCredits).toFixed(
                                2
                              )}
                            </>
                          ) : (
                            <>
                              ...
                              {((totalCreditPoints + 1) / totalCredits).toFixed(
                                2
                              )}
                            </>
                          )}
          ...
          {data.Result === "PASS" && (
            <div className="chart w-4/5" id="g-chart">
          ...
          <footer className="footer footer-center p-4 bg-base-300 text-base-content bg-blue-100 text-center text-black mt-5 w-full bottom-0">
            <aside>
              <p className="footer-text">
                <span className="font-bold">
                  Designed and Developed by @MarkDigital
                </span>{" "}
                | <span className="font-bold">Read Disclaimer</span> |{" "}
                <span className="font-light">v2.0</span>
              </p>
            </aside>
          </footer>
        </>
